...
public class DSL {
    ...
    public void preencheCamposDeUsuarioESenha(String campoUsuario, String campoSenha){ driver.findElement(By.id("user-name")).sendKeys(campoUsuario); driver.findElement(By.id("password")).sendKeys(campoSenha); }
